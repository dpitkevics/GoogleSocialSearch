...
from Facebook.utils import get_post_authorization_redirect_url
from Facebook.views import authorize_application
from Facebook.settings import FACEBOOK_APPLICATION_INITIAL_PERMISSIONS
from Facebook.settings import FACEBOOK_AUTHORIZATION_REDIRECT_URL
