...
from Facebook.settings import FACEBOOK_APPLICATION_CANVAS_URL
from Facebook.settings import FACEBOOK_APPLICATION_DOMAIN
from Facebook.settings import FACEBOOK_APPLICATION_NAMESPACE
from Facebook.settings import DISABLED_PATHS
from Facebook.settings import ENABLED_PATHS
from Facebook.settings import AUTHORIZATION_DENIED_VIEW
from Facebook.settings import FANDJANGO_SITE_URL
